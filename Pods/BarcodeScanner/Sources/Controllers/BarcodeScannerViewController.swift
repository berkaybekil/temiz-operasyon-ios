...
public protocol BarcodeScannerManuelButtonDelegate: class {
...
open class BarcodeScannerViewController: UIViewController {
  ...
  public weak var dismissalDelegate: BarcodeScannerDismissalDelegate?
    public weak var manuelButtonDelegate: BarcodeScannerManuelButtonDelegate?
...
extension BarcodeScannerViewController: HeaderViewControllerDelegate {
    func headerViewControllerDidTapManuelButton(_ controller: HeaderViewController) {
        manuelButtonDelegate?.scannerDidManuelButton(self)
    }
